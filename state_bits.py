"""
state_bits.py — Controlword/Statusword bit constants and helpers for dryve D1.
...
# Controlword bit masks (0x6040) — CiA‑402
CW_SHUTDOWN            = 0x0006  # bits 1 and 2 set (0b0000_0110)
CW_SWITCH_ON           = 0x0007  # bits 0,1,2 (0b0000_0111)
CW_ENABLE_OPERATION    = 0x000F  # bits 0‑3 (0b0000_1111)
CW_DISABLE_VOLTAGE     = 0x0000
CW_QUICK_STOP          = 0x0002
CW_FAULT_RESET         = 0x0080  # bit 7
CW_START_MOTION        = 0x001F  # start of profiled motion/homing


# Statusword bit masks (0x6041) — CiA‑402
...
SW_OP_MODE_SPECIFIC    = 0x1000  # bit 12


class DriveState(IntEnum):
    """CiA‑402 drive states with descriptive names."""
...
class Statusword:
    """Wrapper around the statusword with convenient boolean properties."""
...
def controlword_for_state(state: DriveState) -> int:
    """Return the Controlword value for the given target state."""
    mapping = {
